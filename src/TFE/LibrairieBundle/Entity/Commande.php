...
class Commande
{
     ...
     * @var LivreCommande
     *
     * @ORM\OneToMany(targetEntity="TFE\LibrairieBundle\Entity\LivreCommande", mappedBy="commande", cascade={"persist"})
     *
     */
    ...
    public function getTotalLigneCommandeHtva()
    {
        ...
        {
            $total += ($ligneCommande->getprixVenteFinalHtva() * $ligneCommande->getQuantite());
        }
    ...
    public function getTotalTVALigneCommande()
    {
        ...
        foreach($this->getLivreCommandes() as $ligneCommande)
        {
            $total += ($ligneCommande->getTvaVente() * $ligneCommande->getQuantite());
        }
    ...
    public function getTotalLigneCommande()
    {
        ...
        return $this->getTotalLigneCommandeHtva() + $this->getTotalTVALigneCommande();
    }
